...
note: >
  This release is shaped by user feedback: a publish should never forget which
  site it started from, and a file write should never reach beyond that site.
  Editable section landing pages, Custom order and the expanded front matter
  editor turn that feedback into a safer way to arrange and describe content.
draft: false
